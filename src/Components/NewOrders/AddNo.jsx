...
import { addOrderAPI, getSettingAPI } from "../../Services/allAPI";
...
function AddNo() {
  ...
  //     closedOrder: false,
  //   }));
  // }, [orderData.userName, orderData.closedOrder]);
      ...
      <div>
        <div className="flex flex-wrap">
          ...
          <button
            ...
            onClick={() =>
              document.getElementById("my_modal_1addNO").showModal()
            }
          >
        ...
        <div>
          ...
          <dialog id="my_modal_1addNO" className="modal ">
            <div className="modal-box w-95">
              ...
              <div className="py-4">
                ...
                >
                  <option disabled={false}>Select Products Image</option>
                  {settingData.length > 0
                    ? settingData.map((data) => (
